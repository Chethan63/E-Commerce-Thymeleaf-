...
public class AdminController {
 ...
 public String loadAddProduct(HttpSession session,ModelMap map) {
	 if(session.getAttribute("admin")!=null)
		 ...
		 map.put("fail", "Session Expaied ,login again");
		 return "home";
	 }
 }
 ...
 public String fetchproducts(HttpSession session,ModelMap map) {
	  if(session.getAttribute("admin")!=null) {
		  ...
		  map.put("fail", "Session Expierd,Login Again");
		  return "home";
	  } 
 }
 ...
 public String deleteProduct(@PathVariable int id,ModelMap map,HttpSession session) {
	  if(session.getAttribute("admin")!=null) {
